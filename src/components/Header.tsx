...
const navLinkBase =
  "font-secondary text-xs sm:text-sm font-medium transition-colors hover:opacity-80";
const navLinkActive = "text-[var(--primary)]";
const navLinkInactive = "text-[var(--muted-foreground)] hover:text-[var(--foreground)]";
