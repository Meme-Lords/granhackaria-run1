  ...
  return (
    <header className="flex items-center justify-between h-[60px] sm:h-[70px] md:h-[80px] px-4 sm:px-6 md:px-12 w-full border-b border-[var(--border)]">
      ...
      <nav className="flex items-center gap-4 sm:gap-6">
        <a
          href="/"
          className="font-secondary text-sm font-medium text-[var(--primary)] hover:opacity-80 transition-opacity"
        >
          Events
        </a>
        <a
          href="/about"
          className="font-secondary text-sm font-medium text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors"
        >
          About
        </a>
      </nav>
